      ...
      >
        ...
        <div className="relative">
          ...
          <div className="relative p-8 rounded-3xl bg-slate-900 border border-slate-800">
            ...
            <p className="text-slate-400 mb-8">Sign in to manage your game servers</p>
            ...
            <p className="mt-6 text-center text-slate-400">
              ...
              <Link to={createPageUrl('Register')} className="text-sky-400 hover:text-sky-300 font-medium">
                Register here
              </Link>
            </p>
          </div>
